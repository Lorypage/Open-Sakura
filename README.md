...
## 许可
本仓库以GPLV3协议开放，构建脚本与文档**仅供研究与学习使用**。如果你是 Sakura 的原作者并希望本仓库下架或重新授权，请提 Issues。虽然提了也不会搭理你。

## 声明
破解者对本外挂的其他作者没有敌意，请放下戒备。如果你希望你的外挂不被再次破甲可以加强你的混淆，虽然加强了AI也能解。更加一劳永逸的办法是将秋奈从你们客户端的开发组内部踢出。

## 构建

```bash
等待还原代码中，可以先行从Release获取由辣舞忙斯特结合GPT5.5添加字节码补丁的版本
```
